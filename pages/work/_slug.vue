<template>
    <div class="py-16 pt-48 gap-y-20">
        <header class="grid col-start-2 col-end-12 text-lg gap-y-16">
            <div class="grid gap-y-16">
                <div class="grid lg:grid-cols-4 lg:gap-16">
                    ...
                    <div class="lg:col-span-3">
                        <h1
                            class="text-3xl font-extrabold lg:text-4xl xl:text-5xl"
                ...
                >
                    ...
                    <div
                        class="lg:col-span-3"
                        v-text="md.attributes.client.description"
                    />
                </aside>
            </div>
        </header>
        ...
        <component
            class="grid grid-cols-1 col-start-2 col-end-12 text-lg gap-y-20 gap-x-8 lg:grid-cols-2"
            :is="md.vue.component"
        />
    </div>
</template>
